...
displayErr() {
    ...
    output " "
    output "Make sure you double check you have the correct answers before hitting enter! you Only get one shot at this!"
    output " "
    ...
    read -e -p "Install LetsEncrypt SSL? IMPORTANT! Your domain name must be pointed to this ip server prior to running the script!! [Y/n]: " ssl_install
...
' | sudo -E tee /etc/nginx/blockuseragents.rules >/dev/null 2>&1
    ...
    output " "
    output "Eman is Getting yiimp fron Github, building files and setting file structure."
    output " "
    sleep 3
    
    
    #Now Generating Random Password for stratum
...
sudo chmod +x /var/stratum/config/run.sh
    ...
    # write the right time to the clock.
    sudo hwclock -w
...
' | sudo -E tee /etc/nginx/sites-available/$server_name.conf >/dev/null 2>&1
    ...
    output " "
    output "Now Eman will head over to the database!"
    output " "
    sleep 3
...
output " "
output " "
output "Finally Over Take time To Check . Your mysql information which is saved in ~/.my.cnf. this installer did not directly install anything required to build coins."
output " "
output "Make sure to change your wallet addresses in  /var/web/serverconfig.php file."
output " "
output "Please make sure to add your public and private keys."
output " "
output "Since I Made Your Day Please Consider Donating :): 1DxxCMNr628ESriH7TEcH1DLhyaasuo9hv"
output " "
output "Emmanuelapp : https://instagram.com/_emmanuelapp"
output " "
output " "
